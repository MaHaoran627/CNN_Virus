...
filepath_train="./data/real-world-data/sars-cov2-UW1-subtracted.fastq"
#path for trained model
filepath_model="./data/pretrained_model.h5"
#path for saving final report
filepath_report="./data/final_report_UW1"

d_nucl={"A":0,"C":1,"G":2,"T":3,"N":4}
f_matrix,f_index=get_kmer_from_realdata(filepath_train)
